...
export class AdminPathsController {
  ...
  async listCourseProjects(
    ...
    const data = await this.pathsService.listCourseProjectsForAdmin(
      status,
      approvalStatus,
    );
  ...
  async listFyp(
    ...
    const data = await this.pathsService.listFypForAdmin(
      progress,
      approvalStatus,
    );
    return { success: true, data };
  ...
  async listVentures(
    ...
    const data = await this.pathsService.listVenturesForAdmin(
      visibility,
      approvalStatus,
    );
    return { success: true, data };
  ...
  async setVentureSpotlight(
    @Param('id', ParseUUIDPipe) id: string,
    @Body() dto: SetVentureSpotlightDto,
  ) {
