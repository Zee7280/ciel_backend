/** Canonical names for Pakistan universities — keep in sync with ciel_frontend/src/utils/universityData.ts */
...
export const PAKISTANI_UNIVERSITIES_SET = new Set(PAKISTANI_UNIVERSITIES);
