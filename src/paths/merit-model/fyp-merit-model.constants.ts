...
export const CRIT: Array<{
  ...
  {
    key: 'purpose',
    label: '1 · Purpose & originality',
    max: 15,
    color: '#2563eb',
  },
  {
    key: 'rigor',
    label: '2 · Rigor (route-adjusted)',
    max: 15,
    color: '#0f766e',
  },
  {
    key: 'outcome',
    label: '3 · Substance of outcome',
    max: 20,
    color: '#c98a04',
  },
  ...
  {
    key: 'pot',
    label: '6 · Potential & continuation',
    max: 10,
    color: '#db2777',
  },
  {
    key: 'conn',
    label: '7 · Completeness & connection',
    max: 10,
    color: '#7c3aed',
  },
];
