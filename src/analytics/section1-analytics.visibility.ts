...
const CIEL_STUDENT_UNIVERSITY: Section1AnalyticsStakeholder[] = ['ciel', 'student', 'university'];
const CIEL_UNIVERSITY: Section1AnalyticsStakeholder[] = ['ciel', 'university'];
const CIEL_UNIVERSITY_UN: Section1AnalyticsStakeholder[] = ['ciel', 'university', 'un_government'];
...
export const SECTION1_ANALYTICS_FIELD_DEFINITIONS: Section1AnalyticsFieldDefinition[] = [
    ...
    },
    {
        ...
        stakeholders: ['ciel', 'student', 'partner', 'university', 'un_government'],
    },
    {
...
): { fields: Section1AnalyticsFieldValues; meta: Record<string, Section1AnalyticsFieldMeta> } {
