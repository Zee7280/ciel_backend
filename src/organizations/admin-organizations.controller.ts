...
export class AdminOrganizationsController {
  ...
  async findOne(@Param('id') id: string) {
    const data =
      await this.organizationsService.getAdminOrganizationDetails(id);
    return { success: true, data };
  }
  ...
  reject(
    @Param('id') id: string,
    @Request() req,
    @Body() dto: AdminRejectOrganizationDto,
  ) {
  ...
  addUniversityMember(
    ...
    return this.organizationsService.addStaffMemberToUniversityOrganization(
      organizationId,
      body,
    );
  }
