...
export const CRIT: Array<{
  ...
  {
    key: 'task',
    label: '1 · Task / purpose & alignment',
    max: 10,
    color: '#7c3aed',
  },
  {
    key: 'knowledge',
    label: '2 · Knowledge, context & contribution',
    max: 15,
    color: '#c98a04',
  },
  {
    key: 'method',
    label: '3 · Method / process & disciplinary rigor',
    max: 20,
    color: '#0f766e',
  },
  {
    key: 'output',
    label: '4 · Quality of output / execution',
    max: 15,
    color: '#ea580c',
  },
  {
    key: 'analysis',
    label: '5 · Analysis, findings & application',
    max: 20,
    color: '#2563eb',
  },
  {
    key: 'sustainability',
    label: '6 · Sustainability & SDG integration',
    max: 15,
    color: '#3F7E44',
  },
  {
    key: 'reflection',
    label: '7 · Reflection, limitations & learning',
    max: 5,
    color: '#db2777',
  },
];
